...
def safe_date_range(label, key_prefix, default_start, default_end, min_date=None):
    ...
    max_val = pd.to_datetime("today").date() + pd.Timedelta(days=365) # Dư dả 1 năm tương lai
...
def plot_interbank(df_ib, start_date, end_date, show_legend=True):
    ...
    if not df_ib.empty:
        ...
        if not df1.empty:
            ...
            # Xóa các dòng có Volume = 0 hoặc Rate = 0 để loại bỏ hoàn toàn các khoảng trống
    ...
    fig.update_yaxes(ticklabelposition="inside", automargin=False)
...
with tab_dash:
    ...
    if not data_dict:
        ...
        if is_mobile:
            ...
            f1, h1, _ = plot_interbank(df_ib, pd.to_datetime("2014-01-01"), pd.to_datetime("today"), show_legend=True)
            ...
            f2, h2 = plot_omo(df_omo, pd.to_datetime("2014-01-01"), pd.to_datetime("today"), show_legend=True)
            ...
            f4, h4, df_out4 = plot_exchange_rate(df_fx, pd.to_datetime("2014-01-01"), pd.to_datetime("today"), show_legend=True)
            if h4: 
            ...
            with t1_single:
                d1_st, d1_en = safe_date_range("Chọn khoảng thời gian", 'ib_single', pd.to_datetime("2014-01-01"), pd.to_datetime("today"), min_date=pd.to_datetime("2004-07-12"))
            ...
            with t1_compare:
                ...
                with c1_1:
                    st_1, en_1 = safe_date_range("Khung thời gian 1", 'ib_c1', pd.to_datetime("2014-01-01"), pd.to_datetime("today"), min_date=pd.to_datetime("2004-07-12"))
            ...
            with t2_single:
                d2_st, d2_en = safe_date_range("Chọn khoảng thời gian", 'omo_single', pd.to_datetime("2014-01-01"), pd.to_datetime("today"), min_date=pd.to_datetime("2010-10-14"))
            ...
            with t2_compare:
                ...
                with c2_1:
                    st_21, en_21 = safe_date_range("Khung thời gian 1", 'omo_c1', pd.to_datetime("2014-01-01"), pd.to_datetime("today"), min_date=pd.to_datetime("2010-10-14"))
            ...
            with tab_compare:
                ...
                with col_c1:
                    date_1 = st.date_input("Chọn ngày 1", pd.to_datetime("2014-01-01").date(), min_value=pd.to_datetime("2013-03-19").date(), max_value=pd.to_datetime("today").date(), key="yc1")
                ...
                with col_c2:
                    date_2 = st.date_input("Chọn ngày 2", pd.to_datetime("today").date(), min_value=pd.to_datetime("2013-03-19").date(), max_value=pd.to_datetime("today").date(), key="yc2")
            ...
            with t4_single:
                d4_st, d4_en = safe_date_range("Chọn khoảng thời gian", 'fx_single', pd.to_datetime("2014-01-01"), pd.to_datetime("today"), min_date=pd.to_datetime("2004-04-27"))
            ...
            with t4_compare:
                ...
                with c4_1:
                    st_41, en_41 = safe_date_range("Khung thời gian 1", 'fx_c1', pd.to_datetime("2014-01-01"), pd.to_datetime("today"), min_date=pd.to_datetime("2004-04-27"))
