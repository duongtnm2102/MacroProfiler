...
Biến `st` (streamlit) đã được import sẵn. Hãy print() các thống kê nếu có.'''
    ...
    # Dùng Qwen 32B Coder chuyên biệt cho việc sinh code
    return call_groq(messages, model="qwen-2.5-coder-32b", temperature=0.1)
...
"""
    ...
    # Dùng model openai/gpt-oss-120b, hạ max_tokens xuống 3000, temperature=0 để nội dung cực kỳ thực tế
    return call_groq(messages, model="openai/gpt-oss-120b", temperature=0.0, max_tokens=3000)
